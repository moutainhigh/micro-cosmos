...
public class DateTools {
    ...
    public static String dateToStrM(Date dateDate, String format) {
     ...
     * 得到二个日期间的间隔月份
     */
    public static int getTwoDatePassingMonth(Date date1, Date date2) {
        int year1 = date1.getYear();
        int year2 = date2.getYear();
        int month1 = date1.getMonth();
        int month2 = date2.getMonth();
        int yearPass = year2 - year1;
        int monthPass = month2 - month1;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(strToDate("2016-08-22"));
